...
declare class JsonRpcProvider implements Provider {
    ...
    callFunction<T extends SerializedReturnValue>(contractId: string, method: string, args: Record<string, unknown> | Uint8Array, blockQuery?: BlockReference): Promise<T | undefined>;
    callFunctionRaw(contractId: string, method: string, args: Record<string, unknown> | Uint8Array, blockQuery?: BlockReference): Promise<CallContractViewFunctionResultRaw>;

...
export async function encryptV0(data: Buffer, keyB64: string): Promise<string> {
  // Node.js environment
...
export async function decryptV0(encryptedB64: string, keyB64: string): Promise<Buffer> {

...
export const NEAR_RPC_URL = process.env.NEAR_RPC_URL || 'https://rpc.mainnet.fastnear.com';
export const NEAR_TESTNET_RPC_URL = process.env.NEAR_TESTNET_RPC_URL || 'https://rpc.testnet.fastnear.com';

...
import { rpcCallWithRetry, encodeFunctionCallAction, encodeTransaction, KV_CONTRACT, } from './kv.js';
...
export async function broadcastContractCall(contractId, network, methodName, args, depositYocto = '0') {
    ...
    const action = encodeFunctionCallAction(methodName, callArgs, 50000000000000n, deposit);

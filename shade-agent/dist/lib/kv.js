 ...
 */
export async function signAndBroadcastFunctionCall(receiverId, methodName, argsBytes, gas, deposit, opts = {}) {
    const rpcUrl = KV_RPC_URL;
...
export async function storeBlobToKV(key, encryptedBlob) {
    ...
    const outcome = await signAndBroadcastFunctionCall(KV_CONTRACT, 'store', callArgs, 30000000000000n, 0n);
